...
/**
 * /reports v1 — Artifact library in the Vantablack ink theme.
 *
 * Verbatim copy of the legacy reports/page.tsx (pre-v2). Preserved for the
 * NEXT_PUBLIC_REPORTS_V2=false fallback. 0 functional changes — only the
 * default export name was renamed (ReportsPage → ReportsPageV1).
 *
 * Mirrors the 18 artifact types the backend can generate. When a live
