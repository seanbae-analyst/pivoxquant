...
export default function ReportsPage() {
  ...
  return (
    <FeaturePageShell
      ...
      deck="리포트 양식을 미리 볼 수 있는 페이지입니다. 본인 거래 내역을 연결하면 같은 양식이 본인 데이터로 채워집니다 — 연결 전에는 빈 상태로 보입니다. — A preview of the report formats. Connect your own trading history and the same format fills in with your data; until then it shows an empty state."
      seeAlso={[
        {
          eyebrow: "Catalogue",
