...
export function AddPositionModal({ onDone }: { onDone: () => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger >
        <Button size="sm" className="text-xs">+ Add Position</Button>
      </DialogTrigger>
...
export function EditCapitalModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { setOpen(o); if (o) { setUsd(String(currentUsd)); setKrw(String(currentKrw)); } }}>
      <DialogTrigger >
        <button className="text-[10px] text-primary/60 hover:text-primary">Edit</button>
      </DialogTrigger>
...
export function QuickBuyModal({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger >
        <Button variant="outline" size="sm" className="h-7 text-[10px] text-success hover:bg-success/10">
          + Buy
        </Button>
      </DialogTrigger>
      <DialogContent className="border-border bg-card sm:max-w-sm">
...
export function QuickSellModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { setOpen(o); if (o) setShares(String(maxShares)); }}>
      <DialogTrigger >
        <Button variant="outline" size="sm" className="h-7 text-[10px] text-destructive hover:bg-destructive/10">
          Sell
        </Button>
      </DialogTrigger>
      <DialogContent className="border-border bg-card sm:max-w-sm">
