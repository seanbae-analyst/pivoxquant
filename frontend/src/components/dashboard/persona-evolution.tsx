  ...
  return (
    ...
    >
      <header className="flex items-start justify-between gap-3 flex-wrap">
        ...
        {hasDrift && (
          <span
            className="inline-flex items-center gap-1 font-mono uppercase text-[9.5px] tracking-[0.22em] px-2 py-1 rounded-[2px]"
            style={{
              color: "#a35b3b",
      ...
      {/* Legend */}
      <div
        className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1 text-[10.5px]"
...
function EvolutionChart({
  ...
  return (
    <div className="relative">
      ...
      <div
        className="mt-2 flex justify-between font-mono text-[9.5px] uppercase tracking-[0.2em] tabular-nums"
...
function HoverCard({
  ...
  return (
    ...
    >
      <div
        className="font-mono uppercase text-[9.5px] tracking-[0.22em]"
      ...
      {pulse ? (
        <div className="mt-1 text-[11.5px]" style={{ opacity: 0.85 }}>
          Pulse · mood {pulse.mood}/5 · confidence {pulse.confidence}/5
        </div>
      ) : (
        <div className="mt-1 text-[11.5px]" style={{ opacity: 0.65 }}>
