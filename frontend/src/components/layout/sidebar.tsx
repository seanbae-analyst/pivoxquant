  ...
  return (
    <aside className="flex h-screen w-[220px] flex-col border-r border-slate-200 bg-white">
      ...
      <div className="p-3">
        <Link
          href="/pricing"
          className="flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition-all duration-200 hover:bg-slate-800"
        >
