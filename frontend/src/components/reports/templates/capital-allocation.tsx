...
const DEFAULT: CapitalAllocationData = {
  ...
  sources: [
    ...
    { label: "매각 차익 (PYPL · PayPal)", pct: 74, amount: "$18,680", flat: true },
    { label: "기타 (보너스)", pct: 14, amount: "$0", flat: true },
  ],
  totalSources: "$48,200",
  uses: [
    { label: "신규 매입 (NVDA · NVIDIA, META · Meta Platforms)", pct: 78, amount: "$22,400" },
  ...
  avgLag: "11 days",
  decisions: [
    { name: "NVDA · NVIDIA +5%", when: "Apr 12", deployed: "$12,400", current: "$15,180", ret: "+22.4%", retTone: "pos", irr: "+118%", irrTone: "pos" },
    { name: "META · Meta Platforms 신규", when: "May 02", deployed: "$10,000", current: "$9,580", ret: "−4.2%", retTone: "neg", irr: "−18%", irrTone: "neg" },
    { name: "SCHD · Schwab US Dividend ETF 적립", when: "매월", deployed: "$6,000", current: "$6,260", ret: "+4.3%", retTone: "pos", irr: "+22%", irrTone: "pos" },
    { name: "BND · Vanguard Total Bond 비중 +8%", when: "Apr 28", deployed: "$4,400", current: "$4,444", ret: "+1.0%", retTone: "pos", irr: "+5.5%", irrTone: "pos" },
  ...
  bestDollar: { name: "NVDA · NVIDIA · +22.4%", body: "$12,400 → $15,180. 분기 deployed 자본의 26%가 알파의 64%를 만들었다. Concentration의 양면." },
