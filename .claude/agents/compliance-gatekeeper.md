...
- **검증 명령**:
  ...
  ls /Users/seanbae/Desktop/취준/pivoxquant/alembic/versions/ 2>/dev/null | grep -i email_opt_out
  ```

### B-4: AI 생성물 표시제

- **Source**: `frontend/lib/artifact/` AI 생성 표시 + Weekly Memo / Brag Card / Earnings PDF 템플릿
- **Status 카테고리**: `implemented` / `partial` / `missing`
- **일일 점검**:
...
- **검증 명령**:
  ```bash
  grep -rniE "AI[- ]?생성|AI[- ]?generated|generated by AI" /Users/seanbae/Desktop/취준/pivoxquant/frontend/src/ /Users/seanbae/Desktop/취준/pivoxquant/services/artifact/ 2>/dev/null | wc -l
  ```
