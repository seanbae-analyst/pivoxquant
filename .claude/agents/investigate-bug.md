...
tools: Bash, Read, Grep, Glob, WebFetch, mcp__Claude_in_Chrome__read_network_requests, mcp__Claude_in_Chrome__javascript_tool, mcp__Claude_in_Chrome__navigate, mcp__Claude_in_Chrome__tabs_context_mcp
model: sonnet
---
