...
├── autotrader.py       # 자동매매 (Kill Switch, 5 Circuit Breakers, paper=True)
...
## 중요 원칙
- **기존 백엔드 서비스 파일 수정 금지** — engine.py, quant_models.py, autotrader.py, risk_defense.py 등은 완성 상태
