...
==== 2194 passed, 18 skipped, 1 xfailed, 483 warnings in 310.57s (0:05:10) =====
```
...
### vitest — ✅ exit 0
```
 [32m✓[39m src/lib/__tests__/relative-time-utc.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 3[2mms[22m[39m
 [32m✓[39m src/components/portfolio/v2/__tests__/derive-weight-fx.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 5[2mms[22m[39m
 [32m✓[39m src/components/journal/__tests__/concentration-mirror.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 6[2mms[22m[39m
...
[2m   Start at [22m 03:05:38
[2m   Duration [22m 9.14s[2m (transform 2.05s, setup 3.15s, import 9.86s, tests 9.67s, environment 31.18s)[22m
