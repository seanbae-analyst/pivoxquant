# 야간 빌드 검증 — 2026-09-04 03:00 KST

브랜치: `fix/landing-claims-match-shipped-product`
HEAD: `422170e1 test(journal): run the new mirror for real — and fix the two things that found`
미커밋: 1개 · untracked: 1개
...
==== 1999 passed, 18 skipped, 1 xfailed, 483 warnings in 1080.22s (0:18:00) ====
```
...
### vitest — ✅ exit 0
```
 [32m✓[39m src/components/journal/__tests__/friction-outcome-mirror.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 14[2mms[22m[39m
 [32m✓[39m src/components/journal/__tests__/holding-mirror.test.ts [2m([22m[2m12 tests[22m[2m)[22m[32m 35[2mms[22m[39m
 [32m✓[39m src/lib/cfo/__tests__/coerce-pulse.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 13[2mms[22m[39m
 [32m✓[39m src/data/__tests__/onboarding-slider-seedable.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 4[2mms[22m[39m
 [32m✓[39m src/app/(dashboard)/__tests__/auth-redirect.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 6[2mms[22m[39m
 [32m✓[39m src/__tests__/dashboard-redirect.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 24[2mms[22m[39m

[2m Test Files [22m [1m[32m48 passed[39m[22m[90m (48)[39m
[2m      Tests [22m [1m[32m364 passed[39m[22m[90m (364)[39m
[2m   Start at [22m 03:19:08
[2m   Duration [22m 65.97s[2m (transform 10.77s, setup 24.70s, import 63.41s, tests 74.41s, environment 232.57s)[22m
