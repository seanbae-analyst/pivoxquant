...
==== 2063 passed, 18 skipped, 1 xfailed, 483 warnings in 308.47s (0:05:08) =====
```
...
### vitest — ✅ exit 0
```
 [32m✓[39m src/components/journal/__tests__/concentration-mirror.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 4[2mms[22m[39m
 [32m✓[39m src/lib/__tests__/initials.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 2[2mms[22m[39m
...
[2m   Duration [22m 9.11s[2m (transform 1.94s, setup 3.31s, import 10.03s, tests 9.64s, environment 29.74s)[22m
