...
# 야간 빌드 검증 — 2026-09-11 03:00 KST

브랜치: `chore/remaining-cleanup`
HEAD: `a6cf9d99 fix(dashboard): render every page once, drop the broker reconcile CTAs, move seed`
미커밋: 1개 · untracked: 1개
...
==== 2194 passed, 18 skipped, 1 xfailed, 483 warnings in 313.76s (0:05:13) =====
```
...
### vitest — ✅ exit 0
```
 [32m✓[39m src/data/__tests__/onboarding-slider-seedable.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 7[2mms[22m[39m
 [32m✓[39m src/components/portfolio/__tests__/to-position.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 5[2mms[22m[39m
 [32m✓[39m src/components/journal/__tests__/friction-outcome-mirror.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 4[2mms[22m[39m
...
[2m   Start at [22m 03:05:37
[2m   Duration [22m 9.53s[2m (transform 2.12s, setup 3.33s, import 10.07s, tests 9.82s, environment 31.24s)[22m
