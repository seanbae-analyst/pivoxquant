# 야간 빌드 검증 — 2026-09-07 03:00 KST

브랜치: `fix/sweep-2026-09-04`
HEAD: `74899876 fix(email): every template described a product that was deleted`
미커밋: 1개 · untracked: 1개
...
==== 1995 passed, 18 skipped, 1 xfailed, 483 warnings in 307.17s (0:05:07) =====
```
...
### vitest — ✅ exit 0
```
 [32m✓[39m src/components/portfolio/v2/__tests__/derive-weight-fx.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 4[2mms[22m[39m
 [32m✓[39m src/data/__tests__/onboarding-slider-seedable.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 2[2mms[22m[39m
 [32m✓[39m src/lib/cfo/__tests__/coerce-pulse.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 3[2mms[22m[39m
 [32m✓[39m src/app/(dashboard)/__tests__/auth-redirect.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 3[2mms[22m[39m
 [32m✓[39m src/components/portfolio/__tests__/to-position.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 3[2mms[22m[39m
 [32m✓[39m src/__tests__/dashboard-redirect.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 3[2mms[22m[39m

[2m Test Files [22m [1m[32m49 passed[39m[22m[90m (49)[39m
[2m      Tests [22m [1m[32m368 passed[39m[22m[90m (368)[39m
[2m   Start at [22m 03:05:32
[2m   Duration [22m 11.03s[2m (transform 2.30s, setup 3.69s, import 11.82s, tests 11.02s, environment 37.46s)[22m
