# 야간 빌드 검증 — 2026-09-02 03:00 KST

브랜치: `main`
HEAD: `20a67ecb chore: remove a dev dependency that was never installed`
미커밋: 1개 · untracked: 1개
...
==== 2010 passed, 18 skipped, 1 xfailed, 482 warnings in 312.26s (0:05:12) =====
```
...
```
 ...
 [32m✓[39m src/lib/__tests__/onboarding-surface-label.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 5[2mms[22m[39m
 [32m✓[39m src/lib/cfo/__tests__/coerce-pulse.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 2[2mms[22m[39m
 [32m✓[39m src/data/__tests__/onboarding-slider-seedable.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 2[2mms[22m[39m
...
[2m   Start at [22m 03:05:34
[2m   Duration [22m 8.37s[2m (transform 1.92s, setup 2.85s, import 9.09s, tests 9.13s, environment 28.00s)[22m
...
STALE 11 dormant entries now served or renamed — prune the list:
  ...
  /api/artifacts/stats
OK 68 live frontend endpoints all match a backend route (118 rules parsed)
```
